...
<footer>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <h4 id="menu-title" class="title"><span>MENU</span></h4>
            ...
            <div class="col-md-4">
                <h4 id="contactus-title" class="title"><span>CONTACT US</span></h4>
                <p class="mt-3 mb-1">鼎億自動化股份有限公司(台中總公司)</p>
                <p class="mb-1">Gumptious Technology Co.,</p>
