    ...
    <div id="carouselSliderHome" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100 img-fluid" src="../image/page/home/banner/1.svg" alt="First slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100 img-fluid" src="../image/page/home/banner/2.svg" alt="Second slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100 img-fluid" src="../image/page/home/banner/3.svg" alt="Third slide">
            </div>
        </div>
